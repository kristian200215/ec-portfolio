...
import { Github, Facebook, Mail, MapPin, BadgeCheck } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 flex flex-col items-center px-6 py-6 transition-colors duration-500">
      <header className="max-w-6xl w-full mb-5 flex flex-col items-center gap-4 sm:flex-row sm:justify-between sm:items-start">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Image
            ...
            width={120}
            height={120}
            className="rounded-full border-4 border-zinc-300 dark:border-zinc-700 shadow-lg transition-all duration-500"
          />
      ...
      <section className="w-full max-w-6xl px-2 sm:px-0 flex flex-col gap-6">
